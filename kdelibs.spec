...
Source0:        ftp://ftp.pld-linux.org/software/kde/%{name}-%{version}.tar.bz2
...
BuildRequires:	unsermake >= 050704
...
%define		__unsermake	/usr/share/unsermake/unsermake
...
%endif
	...
	--with-qt-includes=%{_includedir}/qt4 \
...
%attr(755,root,root) %{_bindir}/dcopidlold
...
%dir %{_libdir}/kde4
%{_libdir}/kde4/cupsdconf.la
%attr(755,root,root) %{_libdir}/kde4/cupsdconf.so
%{_libdir}/kde4/dcopserver.la
%attr(755,root,root) %{_libdir}/kde4/dcopserver.so
%{_libdir}/kde4/kaddprinterwizard.la
%attr(755,root,root) %{_libdir}/kde4/kaddprinterwizard.so
%{_libdir}/kde4/katepart.la
%attr(755,root,root) %{_libdir}/kde4/katepart.so
%{_libdir}/kde4/kbuildsycoca.la
%attr(755,root,root) %{_libdir}/kde4/kbuildsycoca.so
%{_libdir}/kde4/kbzip2filter.la
%attr(755,root,root) %{_libdir}/kde4/kbzip2filter.so
%{_libdir}/kde4/kcmshell.la
%attr(755,root,root) %{_libdir}/kde4/kcmshell.so
%{_libdir}/kde4/kconf_update.la
%attr(755,root,root) %{_libdir}/kde4/kconf_update.so
%{_libdir}/kde4/kcookiejar.la
%attr(755,root,root) %{_libdir}/kde4/kcookiejar.so
%{_libdir}/kde4/kded.la
%attr(755,root,root) %{_libdir}/kde4/kded.so
%{_libdir}/kde4/kded_kcookiejar.la
%attr(755,root,root) %{_libdir}/kde4/kded_kcookiejar.so
%{_libdir}/kde4/kded_kdeprintd.la
%attr(755,root,root) %{_libdir}/kde4/kded_kdeprintd.so
%{_libdir}/kde4/kded_kdetrayproxy.la
%attr(755,root,root) %{_libdir}/kde4/kded_kdetrayproxy.so
%{_libdir}/kde4/kded_kpasswdserver.la
%attr(755,root,root) %{_libdir}/kde4/kded_kpasswdserver.so
%{_libdir}/kde4/kded_kssld.la
%attr(755,root,root) %{_libdir}/kde4/kded_kssld.so
%{_libdir}/kde4/kded_kwalletd.la
%attr(755,root,root) %{_libdir}/kde4/kded_kwalletd.so
%{_libdir}/kde4/kded_proxyscout.la
%attr(755,root,root) %{_libdir}/kde4/kded_proxyscout.so
%{_libdir}/kde4/kdeprint_cups.la
%attr(755,root,root) %{_libdir}/kde4/kdeprint_cups.so
%{_libdir}/kde4/kdeprint_ext.la
%attr(755,root,root) %{_libdir}/kde4/kdeprint_ext.so
%{_libdir}/kde4/kdeprint_lpdunix.la
%attr(755,root,root) %{_libdir}/kde4/kdeprint_lpdunix.so
%{_libdir}/kde4/kdeprint_lpr.la
%attr(755,root,root) %{_libdir}/kde4/kdeprint_lpr.so
%{_libdir}/kde4/kdeprint_rlpr.la
%attr(755,root,root) %{_libdir}/kde4/kdeprint_rlpr.so
%{_libdir}/kde4/kdeprint_tool_escputil.la
%attr(755,root,root) %{_libdir}/kde4/kdeprint_tool_escputil.so
#%{_libdir}/kde4/kfileaudiopreview.la
#%attr(755,root,root) %{_libdir}/kde4/kfileaudiopreview.so
%{_libdir}/kde4/kgzipfilter.la
%attr(755,root,root) %{_libdir}/kde4/kgzipfilter.so
%{_libdir}/kde4/khtmlimagepart.la
%attr(755,root,root) %{_libdir}/kde4/khtmlimagepart.so
%{_libdir}/kde4/kimg_dds.la
%attr(755,root,root) %{_libdir}/kde4/kimg_dds.so
%{_libdir}/kde4/kimg_eps.la
%attr(755,root,root) %{_libdir}/kde4/kimg_eps.so
%{_libdir}/kde4/kimg_exr.la
%attr(755,root,root) %{_libdir}/kde4/kimg_exr.so
#%{_libdir}/kde4/kimg_hdr.la
#%attr(755,root,root) %{_libdir}/kde4/kimg_hdr.so
%{_libdir}/kde4/kimg_ico.la
%attr(755,root,root) %{_libdir}/kde4/kimg_ico.so
#%{_libdir}/kde4/kimg_jp2.la
#%attr(755,root,root) %{_libdir}/kde4/kimg_jp2.so
%{_libdir}/kde4/kimg_pcx.la
%attr(755,root,root) %{_libdir}/kde4/kimg_pcx.so
%{_libdir}/kde4/kimg_psd.la
%attr(755,root,root) %{_libdir}/kde4/kimg_psd.so
%{_libdir}/kde4/kimg_rgb.la
%attr(755,root,root) %{_libdir}/kde4/kimg_rgb.so
%{_libdir}/kde4/kimg_tga.la
%attr(755,root,root) %{_libdir}/kde4/kimg_tga.so
%{_libdir}/kde4/kimg_tiff.la
%attr(755,root,root) %{_libdir}/kde4/kimg_tiff.so
%{_libdir}/kde4/kimg_xcf.la
%attr(755,root,root) %{_libdir}/kde4/kimg_xcf.so
%{_libdir}/kde4/kimg_xview.la
%attr(755,root,root) %{_libdir}/kde4/kimg_xview.so
%{_libdir}/kde4/kio_file.la
%attr(755,root,root) %{_libdir}/kde4/kio_file.so
%{_libdir}/kde4/kio_ftp.la
%attr(755,root,root) %{_libdir}/kde4/kio_ftp.so
%{_libdir}/kde4/kio_ghelp.la
%attr(755,root,root) %{_libdir}/kde4/kio_ghelp.so
%{_libdir}/kde4/kio_help.la
%attr(755,root,root) %{_libdir}/kde4/kio_help.so
%{_libdir}/kde4/kio_http.la
%attr(755,root,root) %{_libdir}/kde4/kio_http.so
%{_libdir}/kde4/kio_http_cache_cleaner.la
%attr(755,root,root) %{_libdir}/kde4/kio_http_cache_cleaner.so
%{_libdir}/kde4/kio_metainfo.la
%attr(755,root,root) %{_libdir}/kde4/kio_metainfo.so
%{_libdir}/kde4/kio_uiserver.la
%attr(755,root,root) %{_libdir}/kde4/kio_uiserver.so
%{_libdir}/kde4/kjavaappletviewer.la
%attr(755,root,root) %{_libdir}/kde4/kjavaappletviewer.so
%{_libdir}/kde4/klauncher.la
%attr(755,root,root) %{_libdir}/kde4/klauncher.so
#%{_libdir}/kde4/knotify.la
#%attr(755,root,root) %{_libdir}/kde4/knotify.so
%{_libdir}/kde4/kspell_aspell.la
%attr(755,root,root) %{_libdir}/kde4/kspell_aspell.so
%{_libdir}/kde4/kspell_ispell.la
%attr(755,root,root) %{_libdir}/kde4/kspell_ispell.so
#%{_libdir}/kde4/kstyle_highcontrast_config.la
#%attr(755,root,root) %{_libdir}/kde4/kstyle_highcontrast_config.so
#%{_libdir}/kde4/kstyle_plastik_config.la
#%attr(755,root,root) %{_libdir}/kde4/kstyle_plastik_config.so
#%{_libdir}/kde4/ktexteditor_autobookmarker.la
#%attr(755,root,root) %{_libdir}/kde4/ktexteditor_autobookmarker.so
%{_libdir}/kde4/ktexteditor_docwordcompletion.la
%attr(755,root,root) %{_libdir}/kde4/ktexteditor_docwordcompletion.so
%{_libdir}/kde4/ktexteditor_insertfile.la
%attr(755,root,root) %{_libdir}/kde4/ktexteditor_insertfile.so
%{_libdir}/kde4/ktexteditor_isearch.la
%attr(755,root,root) %{_libdir}/kde4/ktexteditor_isearch.so
%{_libdir}/kde4/ktexteditor_kdatatool.la
%attr(755,root,root) %{_libdir}/kde4/ktexteditor_kdatatool.so
#%{_libdir}/kde4/libkatepart.la
#%attr(755,root,root) %{_libdir}/kde4/libkatepart.so
%{_libdir}/kde4/libkcertpart.la
%attr(755,root,root) %{_libdir}/kde4/libkcertpart.so
%{_libdir}/kde4/libkdeprint_management_module.la
%attr(755,root,root) %{_libdir}/kde4/libkdeprint_management_module.so
%{_libdir}/kde4/libkhtmlpart.la
%attr(755,root,root) %{_libdir}/kde4/libkhtmlpart.so
%{_libdir}/kde4/libkmultipart.la
%attr(755,root,root) %{_libdir}/kde4/libkmultipart.so
%{_libdir}/kde4/libshellscript.la
%attr(755,root,root) %{_libdir}/kde4/libshellscript.so
#%{_libdir}/kde4/wmfthumbnail.la
#%attr(755,root,root) %{_libdir}/kde4/wmfthumbnail.so
%dir %{_libdir}/kde4/plugins
%dir %{_libdir}/kde4/plugins/designer
%{_libdir}/kde4/plugins/designer/kdewidgets.la
%attr(755,root,root) %{_libdir}/kde4/plugins/designer/kdewidgets.so
%dir %{_libdir}/kde4/plugins/styles
#%{_libdir}/kde4/plugins/styles/highcolor.la
#%attr(755,root,root) %{_libdir}/kde4/plugins/styles/highcolor.so
#%{_libdir}/kde4/plugins/styles/highcontrast.la
#%attr(755,root,root) %{_libdir}/kde4/plugins/styles/highcontrast.so
%{_libdir}/kde4/plugins/styles/keramik.la
%attr(755,root,root) %{_libdir}/kde4/plugins/styles/keramik.so
#%{_libdir}/kde4/plugins/styles/kthemestyle.la
#%attr(755,root,root) %{_libdir}/kde4/plugins/styles/kthemestyle.so
#%{_libdir}/kde4/plugins/styles/light.la
#%attr(755,root,root) %{_libdir}/kde4/plugins/styles/light.so
#%{_libdir}/kde4/plugins/styles/plastik.la
...
%{_libdir}/kde4/kabc_dir.la
%attr(755,root,root) %{_libdir}/kde4/kabc_dir.so
%{_libdir}/kde4/kabc_file.la
%attr(755,root,root) %{_libdir}/kde4/kabc_file.so
%{_libdir}/kde4/kabc_ldapkio.la
%attr(755,root,root) %{_libdir}/kde4/kabc_ldapkio.so
%{_libdir}/kde4/kabc_net.la
%attr(755,root,root) %{_libdir}/kde4/kabc_net.so
%{_libdir}/kde4/kabcformat_binary.la
%attr(755,root,root) %{_libdir}/kde4/kabcformat_binary.so
%{_libdir}/kde4/kcm_kresources.la
